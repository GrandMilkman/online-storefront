...
<link href="<c:url value="/resources/plugins/animate/animate.css" />"
	rel="stylesheet">
<link
	href="<c:url value="/resources/plugins/css-hamburgers/hamburgers.min.css" />"
	rel="stylesheet">
<link
	href="<c:url value="/resources/plugins/animsition/css/animsition.min.css"/>"
	rel="stylesheet">
<link href="<c:url value="/resources/plugins/select2/select2.min.css"/>"
	rel="stylesheet">
<link
	href="<c:url value="/resources/pludins/daterangepicker/daterangepicker.css"/>"
	rel="stylesheet">
<link href="<c:url value="/resources/styles/util.css" />"
	rel="stylesheet">
...
<script
	src="<c:url value="/resources/plugins/countdowntime/countdowntime.js"/>"></script>
<script
...
<script
	src="<c:url value="/resources/plugins/animsition/js/animsition.min.js"/>"></script>
<script
	src="<c:url value="/resources/plugins/jquery/jquery-3.2.1.min.js"/>"></script>
				...
				<form action="/storefront/login" method="post">
					<div class="wrap-input100 validate-input m-t-85 m-b-35"
						...
						<input class="input100" type="text" id="user_name"
							name="user_name"> <span class="focus-input100"
					...
					<div class="wrap-input100 validate-input m-b-50"
						...
						<input class="input100" type="password" id="user_password"
							name="user_password"> <span class="focus-input100"
